...
date='20221026' #date of observations
Tprimary_UT='2022-10-27T03:47:00.000'#'2022-10-27T03:47:00'# #time of primary transit midpoint for this epoch
telescope = 'gemini-s' #options are gemini-s, gemini-n; for barycentric velocity correction
Per=1.809886 #period
...
phi,Vbary,grid_RAW,data_RAW,wlgrid,data=make_cube.make_cube(path,date,Tprimary_UT,Per,radeg,decdeg,skyorder,exptime,badorders,trimedges,telescope,plot=True,output=True,testorders=False)

#Perform wavelength calibration
wlgrid,wavecorrect=wavecal.correct(wlgrid,data,skyorder,plot=True,output=True,norm=False)
...
# #Perform PCA
wlgrid,pca_clean_data,pca_noplanet=do_pca.do_pca(wlgrid,wavecorrect,4,test_pca=False,plot=True,output=False)
